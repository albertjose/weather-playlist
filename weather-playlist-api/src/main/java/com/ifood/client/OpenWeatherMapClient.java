...
@FeignClient(url = "${app.open-weather-map.api-url}", name = "open-weather-map-client", fallback = OpenWeatherMapClientFallback.class, configuration = CoreFeignConfiguration.class)
